...
void CCmdWindow::ResetDialogControls(CDXUTDialog *pGameUI)
{
	...
	if(pGameUI) {
		...
		m_pEditControl->GetElement(1)->TextureColor.Init(D3DCOLOR_ARGB( 200, 255, 255, 255 ));
		m_pEditControl->GetElement(2)->TextureColor.Init(D3DCOLOR_ARGB( 200, 255, 255, 255 ));
		m_pEditControl->GetElement(3)->TextureColor.Init(D3DCOLOR_ARGB( 200, 255, 255, 255 ));
		m_pEditControl->GetElement(4)->TextureColor.Init(D3DCOLOR_ARGB( 200, 255, 255, 255 ));
		m_pEditControl->GetElement(5)->TextureColor.Init(D3DCOLOR_ARGB( 200, 255, 255, 255 ));
		m_pEditControl->GetElement(6)->TextureColor.Init(D3DCOLOR_ARGB( 200, 255, 255, 255 ));
		m_pEditControl->GetElement(7)->TextureColor.Init(D3DCOLOR_ARGB( 200, 255, 255, 255 ));
		m_pEditControl->GetElement(8)->TextureColor.Init(D3DCOLOR_ARGB( 200, 255, 255, 255 ));
		m_pEditControl->SetTextColor(D3DCOLOR_ARGB( 255, 255, 255, 255 ));
		m_pEditControl->SetCaretColor(D3DCOLOR_ARGB( 255, 150, 150, 150 ));
		m_pEditControl->SetSelectedBackColor(D3DCOLOR_ARGB(255, 0, 0, 0));
...
void CCmdWindow::SendToServer(char* szServerCommand)
{
	...
	pNetGame->GetRakClient()->RPC(&RPC_ServerCommand, &bsParams, HIGH_PRIORITY, RELIABLE, 0, FALSE, UNASSIGNED_NETWORK_ID, NULL);
