...
{	
	switch(byteWeaponID) {
		...
		case WEAPON_FLAMETHROWER:		return "*";
		...
		case WEAPON_PASSENGER_DRIVEBY:	return "S";
		case WEAPON_FIRE:				return "P";
		case WEAPON_SUICIDE:			return "O";
		case SPECIAL_ENTRY_CONNECT:		return "N";
